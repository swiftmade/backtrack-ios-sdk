...
# place a proper access token here
access_token = "token"
...
url_template = "http://a.tiles.mapbox.com/v4/marker/pin-m-%{icon}+#{color}%{size}.png?access_token=#{access_token}"

#puts url_template % {icon: "test", color: "test", size:"2@"}
